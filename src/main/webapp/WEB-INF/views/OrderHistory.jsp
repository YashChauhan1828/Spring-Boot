<%@page import="com.bean.EcomOrderProductBean"%>
<%@page import="com.bean.EcomOrderBean"%>
...
<div class="container mt-5">
    ...
    <%
        List<EcomOrderProductBean> products = (List<EcomOrderProductBean>) request.getAttribute("products");
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped bg-white">
            ...
            <tbody>
            <%
                for(EcomOrderProductBean p : products) {
